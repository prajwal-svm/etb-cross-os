#let check-attributes(
  ...
  language: none,
  at-university: none,
  confidentiality-marker: none,
  type-of-thesis: none,
  type-of-degree: none,
  show-confidentiality-statement: none,
  show-declaration-of-authorship: none,
  show-gender-disclaimer: none,
  show-table-of-contents: none,
  show-acronyms: none,
  show-list-of-figures: none,
  show-list-of-tables: none,
  show-code-snippets: none,
  show-abstract: none,
  header: none,
  numbering-alignment: none,
  toc-depth: none,
  acronym-spacing: none,
  glossary-spacing: none,
  abstract: none,
  appendix: none,
  acronyms: none,
  university: none,
  ...
  logo-left: none,
  logo-right: none,
  logo-size-ratio: none,
  university-short: none,
  university-declined: none,
  heading-numbering: none,
  math-numbering: none,
  ignored-link-label-keys-for-highlighting: none,
  page-numbering: none,
) = {
