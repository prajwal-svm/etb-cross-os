...
#align(center)[
  #text(2em, weight: "bold", fill: rgb("#1e3a8a"))[高松灯]
  #linebreak()
  运动控制算法工程师（强化学习方向）
  #linebreak()
  #link("mailto:gaosongdeng@163.com")[gaosongdeng\@163.com] · 138XXXX8899 · 北京市 · #link("https://github.com/gaosongdeng-rl")[github.com/gaosongdeng-rl]
]
